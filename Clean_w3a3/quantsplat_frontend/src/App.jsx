...
export default function App() {
  ...
  return <main>
    <header><a className="brand" href="/">QUANTSPLAT</a><nav className="app-nav" aria-label="Main navigation"><button className={page === "research" ? "active" : ""} onClick={() => setPage("research")}>Research explorer</button><button className={page === "create" ? "active action" : ""} onClick={() => setPage("create")}>Create reconstruction</button></nav></header>
